...
export default function Articles(){
    return(
        <div className="max-w-[720px] md:max-w-[960px] lg:max-w-[1400px] xl:max-w-8xl mx-auto px-2 flex flex-col items-center mb-24 md:mb-40">
            <p className="uppercase font-work text-[16px] font-medium">Latest News</p>
            ...
            <a href="#" className="group border relative border-black py-6 px-10 mt-16 overflow-hidden">
                <p className="uppercase font-oswald text-[16px] lg:text-[20px] font-light group-hover:text-white z-20 relative">More Focus News</p>
